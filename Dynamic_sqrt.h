/*
Calc. MIDI velocity proportional to sqrt of velocity of pressed key:
...
velocity(t) = 127 * sqrt(t_127/t) so that velocity(t_127) = 127
*/
...
void initVelocities() {
  for (int t = 0; t < t_max; t++) {
    ...
    if (t <= t_127)
      ...
      velocity = 127.0 * sqrt(1.0 * t_127 / t);
